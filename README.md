...
```bash
wget https://github.com/fabianishere/udm-kernel-tools/releases/download/v1.1.1/udm-kernel-tools_1.1.1_arm64.deb
apt install ./udm-kernel-tools_1.1.1_arm64.deb
```
